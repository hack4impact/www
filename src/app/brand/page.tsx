...
const colors = [
  {
    ...
    key: 'green',
    swatches: [
      { label: '50', hex: '#e2fbdb', tw: 'bg-blue-50' },
      { label: '100', hex: '#bff6b2', tw: 'bg-blue-100' },
      { label: '200', hex: '#96ef80', tw: 'bg-blue-200' },
      { label: '300', hex: '#5fe73e', tw: 'bg-blue-300', primary: true },
      { label: '400', hex: '#36b817', tw: 'bg-blue-400' },
      { label: '500', hex: '#2b9212', tw: 'bg-blue-500' },
      { label: '600', hex: '#21700e', tw: 'bg-blue-600' },
      { label: '700', hex: '#18500a', tw: 'bg-blue-700' },
      { label: '800', hex: '#0d2d06', tw: 'bg-blue-800' },
      { label: '900', hex: '#091e04', tw: 'bg-blue-900' },
      { label: '950', hex: '#061302', tw: 'bg-blue-950' },
    ],
  },
  {
    name: 'Blue',
