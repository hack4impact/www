...
const options: Options = {
  ...
  renderNode: {
    ...
    [BLOCKS.TABLE_HEADER_CELL]: (_node, children) => (
      <th className="border border-gray-300 px-4 py-2 text-base font-sans bg-gray-50">{children}</th>
    ),
    [INLINES.HYPERLINK]: (node, children) => (
      <a href={node.data.uri} className="underline text-blue-700 hover:text-blue-900" target="_blank" rel="noopener noreferrer">
        {children}
      </a>
    ),
  },
