    ...
    <footer className='mt-auto bg-green-300 text-green-600'>
      <div className='px-8 py-8 md:px-12 md:py-12'>
        <div className='grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5'>
          ...
          <div className='hidden md:flex items-start gap-5 lg:justify-end lg:col-start-5'>
            <a
        ...
        {/* Seal and logomark — below grid, right-aligned on mobile */}
        <div className='mt-8 flex items-start justify-end gap-5 md:hidden'>
          <a
            aria-label='Candid transparency seal'
            href='https://app.candid.org/profile/9565390/hack4impact-81-0790890/?pkId=ed396921-76d9-4a6a-a362-b68f17102c35'
            target='_blank'
